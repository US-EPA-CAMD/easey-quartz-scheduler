...
{
  public class cO2cSubDataMonitorHourlyCategory : cCategoryHourly
  {
    #region Constructors

    public cO2cSubDataMonitorHourlyCategory(cCheckEngine ACheckEngine,
    ...
    protected override bool SetErrorSuppressValues()
    {
      ...
      DataRowView monitorHourlyRecord;
      {
        if (GetCheckParameter("Current_O2_Dry_Missing_Data_Monitor_Hourly_Record").ValueAsDataRowView() != null)
          monitorHourlyRecord = GetCheckParameter("Current_O2_Dry_Missing_Data_Monitor_Hourly_Record").ValueAsDataRowView();
        else
          monitorHourlyRecord = GetCheckParameter("Current_O2_Wet_Missing_Data_Monitor_Hourly_Record").ValueAsDataRowView();
      }
