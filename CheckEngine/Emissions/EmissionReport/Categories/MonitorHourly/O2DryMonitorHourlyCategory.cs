...
{
  public class cO2DryMonitorHourlyCategory : cCategoryHourly
  {

    #region Constructors

    public cO2DryMonitorHourlyCategory(cCheckEngine ACheckEngine,
                                       cEmissionsReportProcess AHourlyEmissionsData,
                                       cOperatingHourCategory AOperatingHourCategory)
      : base(AOperatingHourCategory,
             "O2DMH",
             "MONITOR_HRLY_VALUE",
             AHourlyEmissionsData.MonitorHourlyValueO2Dry,
             "O2_Dry_Monitor_Hourly_Value_Records_By_Hour_Location",
    ...
    protected override bool SetErrorSuppressValues()
    {
      ...
      DataRowView monitorHourlyRecord = GetCheckParameter("Current_O2_Dry_Monitor_Hourly_Record").ValueAsDataRowView();
