...
namespace ECMPS.Checks.Parameters
{
  ...
  /// </summary>
  public class cCheckParameterDateValue : cCheckParameterAbstractValue<DateTime, DateTime?>
  {
    ...
    public cCheckParameterDateValue(int? AParameterKey, string AParameterName,
    ...
    /// </summary>
    /// <returns></returns>
    public DateTime AsBeginDateTime()
    {
      DateTime result;
