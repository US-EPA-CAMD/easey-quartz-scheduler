...
namespace ECMPS.Checks.Parameters
{
  ...
  /// </summary>
  public class cCheckParameterDataViewHourly : cCheckParameterAbstractDataView
  {
    ...
    public cCheckParameterDataViewHourly(int? AParameterKey, string AParameterName,
    ...
    /// </summary>
    protected string FOpHourName = "Begin_Hour";
    ...
    #region Public Methods: InitValue
    ...
    public void InitValue(DateTime AOpDate, int AOpHour, string AMonLocId, cCheckCategory AOwner)
    {
      if (SetValueCheckAndPrep(AOwner))
      {
        Scope(AOpDate, AOpHour, AMonLocId);
      }
    }
    ...
    /// <param name="AOpHour">The operating hour of the requested scoped data.</param>
    /// <param name="AMonLocId">The monitor location id of the requested scoped data.</param>
    public virtual void InitValue(DateTime AOpDate, int AOpHour, string AMonLocId)
    {
      InitValue(AOpDate, AOpHour, AMonLocId, (cCheckCategory)null);
    }
    ...
    /// <param name="AOpHour">The operating hour of the requested scoped data.</param>
    /// <param name="AMonLocId">The monitor location id of the requested scoped data.</param>
    protected void Scope(DateTime AOpDate, int AOpHour, string AMonLocId)
    {
      ...
      else
      {
        ...
        while ((CheckPos < FSourceDataTable.DefaultView.Count) && !Done)
        {
          ...
          OpHour = cDBConvert.ToHour(FSourceDataTable.DefaultView[CheckPos][FOpHourName], DateTypes.START);
