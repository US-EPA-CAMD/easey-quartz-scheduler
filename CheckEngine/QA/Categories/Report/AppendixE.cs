...
{
  public class cAppendixE : cQaTestReportCategory
  {
    ...
    public cAppendixE(cCheckEngine CheckEngine, cQAMain QA, string MonitorLocationID, string TestSumID)
      : base(QA, "APPE")
    {
    ...
    public cAppendixE(cQAMain qaReportProcess, bool processInitialized, string MonitorLocationID, string TestSumID)
      : base(qaReportProcess, "APPE")
    {
      InitializeCurrent(MonitorLocationID, TestSumID);
    ...
    {
      SetCheckParameter("Current_Appendix_E_Test", new DataView(mQA.SourceData.Tables["QAAppendixE"],
      ...
      SetCheckParameter("APPE_Run_Records", new DataView(mQA.SourceData.Tables["QAAppendixERun"],
        "", "begin_date, begin_hour, begin_min", DataViewRowState.CurrentRows), eParameterDataType.DataView);

      SetCheckParameter("APPE_Test_Records", new DataView(mQA.SourceData.Tables["QAAppendixE"],
      ...
      SetCheckParameter("APPE_Gas_Records", new DataView(mQA.SourceData.Tables["QAAppendixEGas"],
        "", "", DataViewRowState.CurrentRows), eParameterDataType.DataView);

      SetCheckParameter("APPE_Oil_Records", new DataView(mQA.SourceData.Tables["QAAppendixEOil"],
        "", "", DataViewRowState.CurrentRows), eParameterDataType.DataView);
