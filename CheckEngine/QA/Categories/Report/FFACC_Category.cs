...
{
  public class cFFACC : cQaTestReportCategory
  {
    ...
    public cFFACC(cCheckEngine CheckEngine, cQAMain QA, string MonitorLocationID, string TestSumID)
      : base(QA, "FFACC")
    {
    ...
    {
      SetCheckParameter("Current_Accuracy_Test", new DataView(mQA.SourceData.Tables["QAAccuracyTest"],
      ...
      SetCheckParameter("Accuracy_Test_Records", new DataView(mQA.SourceData.Tables["QAAccuracyTest"],
        "component_id = '" + mComponentID + "'", "", DataViewRowState.CurrentRows), eParameterDataType.DataView);
      ...
      SetCheckParameter("Accuracy_Test_Method_Code_Lookup_Table", new DataView(mQA.SourceData.Tables["AccuracyTestMethodCode"],
          "", "", DataViewRowState.CurrentRows), eParameterDataType.DataView);
