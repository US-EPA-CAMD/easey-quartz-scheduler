...
{
  public class cFF2LTST : cQaTestReportCategory
  {
    ...
    public cFF2LTST(cCheckEngine CheckEngine, cQAMain QA, string MonitorLocationID, string TestSumID)
      : base(QA, "FF2LTST")
    {
    ...
    {
      SetCheckParameter("Current_Fuel_Flow_To_Load_Test", new DataView(mQA.SourceData.Tables["QAFuelFlowToLoadTest"],
        "test_sum_id = '" + mTestSumID + "'", "", DataViewRowState.CurrentRows)[0], eParameterDataType.DataRowView);

      mMonSysID = cDBConvert.ToString(((DataRowView)GetCheckParameter("Current_Fuel_Flow_To_Load_Test").ParameterValue)["mon_sys_id"]);
      ...
      SetCheckParameter("Fuel_Flow_To_Load_Test_Records", new DataView(mQA.SourceData.Tables["QAFuelFlowToLoadTest"],
        "mon_sys_id = '" + mMonSysID + "'", "", DataViewRowState.CurrentRows), eParameterDataType.DataView);
      ...
      SetCheckParameter("System_System_Component_Records", new DataView(mQA.SourceData.Tables["QASystemSystemComponent"],
        "", "", DataViewRowState.CurrentRows), eParameterDataType.DataView);
    }
