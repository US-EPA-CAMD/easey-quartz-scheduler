...
{
  public class cCalibration : cQaTestReportCategory
  {
    ...
    public cCalibration(cCheckEngine CheckEngine, cQAMain QA, string MonitorLocationID, string TestSumID)
      : base(QA, "7DAY")
    {
    ...
    protected override void FilterData()
    {
      ...
      SetCheckParameter("Current_7Day_Calibration_Test", new DataView(mQA.SourceData.Tables["QACalibrationTest"],
      ...
      SetCheckParameter("Calibration_Test_Records", new DataView(mQA.SourceData.Tables["QACalibrationTest"],
        "component_id = '" + mComponentID + "'", "", DataViewRowState.CurrentRows), eParameterDataType.DataView);
