...
namespace ECMPS.Checks.MonitorPlanEvaluation
{
  public class cMonitorLocation : cCategory
  {
    ...
    public cMonitorLocation GetInitialized(cCheckEngine ACheckEngine, cMonitorPlan AMonitorPlanProcess)
    {
      var Category = new cMonitorLocation(ACheckEngine, AMonitorPlanProcess);
