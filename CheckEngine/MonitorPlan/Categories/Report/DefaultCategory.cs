...
namespace ECMPS.Checks.MonitorPlanEvaluation
{
  public class cDefaultCategory : cCategory
  {
    ...
    public  cDefaultCategory GetInitialized(cCheckEngine ACheckEngine, cMonitorPlan AMonitorPlanProcess)
    {
      var Category = new cDefaultCategory(ACheckEngine, AMonitorPlanProcess);
