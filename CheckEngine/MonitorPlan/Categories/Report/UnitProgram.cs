...
namespace ECMPS.Checks.MonitorPlanEvaluation
{
  public class cUnitProgram : cCategory
  {
    ...
    public  cUnitProgram GetInitialized(cCheckEngine ACheckEngine, cMonitorPlan AMonitorPlanProcess)
    {
      var Category = new cUnitProgram(ACheckEngine, AMonitorPlanProcess);
