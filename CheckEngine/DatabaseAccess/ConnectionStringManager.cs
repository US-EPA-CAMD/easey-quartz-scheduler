...
namespace DatabaseAccess
{
    ...
    public static class ConnectionStringManager
    {
        ...
        public static string getConnectionString(IConfiguration configuration)
        {
            ...
            connectionIdleLifetime  = Configuration.GetValue<int>("EASEY_DB_IDLE_TIMEOUT", 30000);
            connectionTimeout       = Configuration.GetValue<int>("EASEY_DB_CONNECTION_TIMEOUT", 10000);
            statementTimeout        = Configuration.GetValue<int>("EASEY_DB_STATEMENT_TIMEOUT", 300000);
            connectionLifeTime       = Configuration.GetValue<int>("EASEY_DB_CONNECTION_LIFE_TIME", 600);
