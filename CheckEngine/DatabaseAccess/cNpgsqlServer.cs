...
namespace ECMPS.Checks.DatabaseAccess
{
    ...
    public class cDatabase
    {
        ...
        /// <returns>True if successfull, False otherwise</returns>
        public bool CreateStoredProcedureCommand(string sProcName, NpgsqlTransaction sqlTrans)
        {
            Debug.Assert(m_sqlConn != null, "m_sqlConn is null.");
            if (m_sqlConn == null)
                return false;
        ...
        /// <param name="sqlTrans">The SqlTransaction object to associate with this command</param>
        /// <returns>True if successfull, False otherwise</returns>
        public bool CreateTextCommand(string sSQL, NpgsqlTransaction sqlTrans)
        {
            Debug.Assert(m_sqlConn != null, "m_sqlConn is null.");
            if (m_sqlConn == null)
                return false;
        ...
        public DataSet GetDataSet()
        {
            ...
            try
            {
                adapter = new NpgsqlDataAdapter(m_sqlCmd);
            ...
            catch (PostgresException sqlEx)
            {
                ...
                m_sLastError = string.Format("Procedure: {0} - {1}", sqlEx.Routine, sqlEx.Message);
        ...
        public DataSet GetDataSet(string sSQL)
        {
            ...
            try
            {
                adapter = new NpgsqlDataAdapter(sSQL, m_sqlConn);
        ...
        /// <summary>
        /// Executes the NpgsqlCommand on the Connection and builds a SqlDataReader. 
        /// </summary>
        ...
        public NpgsqlDataReader ExecuteReader()
        {
            ...
            NpgsqlDataReader drResults = null;
        ...
        /// <returns>The SqlDataReader result set</returns>
        public NpgsqlDataReader ExecuteReader(string sSQL)
        {
            Debug.Assert(m_sqlConn != null, "m_sqlConn is null.");
            if (m_sqlConn == null)
                return null;
        ...
        public void AddInputParameter(string sParamName, string sValue)
        {
            ...
            param.NpgsqlDbType = NpgsqlDbType.Varchar; //was SqldbType.VarChar
        ...
        public void AddInputParameter(string sParamName, int nValue)
        {
            ...
            param.Value = nValue;
            param.ParameterName = sParamName;
            param.NpgsqlDbType = NpgsqlDbType.Integer; //was SqldbType.Int
            param.Direction = ParameterDirection.Input;
        ...
        public void AddInputParameter(string sParamName, decimal nValue)
        {
            ...
            param.Value = nValue;
            param.ParameterName = sParamName;
            param.NpgsqlDbType = NpgsqlDbType.Numeric; //was SqlDbType.Decimal
            param.Direction = ParameterDirection.Input;
        ...
        public void AddInputParameter(string sParamName, DateTime dtValue)
        {
            ...
            // TODO: verify conversion from SqlDateTime.MinValue to NpgsqlDateTime.NegativeInfinity
            ...
            param.ParameterName = sParamName;
            param.NpgsqlDbType = NpgsqlDbType.Timestamp; // was SqlDbType.DateTime;
            param.Direction = ParameterDirection.Input;
        ...
        public void AddInputParameter(string sParamName, NpgsqlDbType dbType, object oValue)
        {
            Debug.Assert(m_sqlCmd != null, "m_sqlCmd is null.");
        ...
        /// </summary>
        /// <param name="sParamName">The name of the parameter</param>
        /// <param name="NpgsqlDbType">The SQL database type of the parameter</param>
        public void AddOutputParameter(string sParamName, NpgsqlDbType NpgsqlDbType)
        {
            Debug.Assert(m_sqlCmd != null, "m_sqlCmd is null.");

            NpgsqlParameter param = new NpgsqlParameter(sParamName, NpgsqlDbType);
        ...
        public void AddOutputParameterInt(string sParamName)
        {
            ...
            NpgsqlParameter param = new NpgsqlParameter(sParamName, NpgsqlTypes.NpgsqlDbType.Integer);
            param.Direction = ParameterDirection.Output;
            m_sqlCmd.Parameters.Add(param);
        }
        ...
        public void AddOutputParameterDateTime(string sParamName)
        {
            ...
            NpgsqlParameter param = new NpgsqlParameter(sParamName, NpgsqlDbType.Timestamp);  //was SqldbType.DateTime;
            param.Direction = ParameterDirection.Output;
            m_sqlCmd.Parameters.Add(param);
        }
        ...
        public void AddOutputParameterDecimal(string sParamName)
        {
            ...
            NpgsqlParameter param = new NpgsqlParameter(sParamName, NpgsqlTypes.NpgsqlDbType.Numeric);
            param.Direction = ParameterDirection.Output;
            m_sqlCmd.Parameters.Add(param);
        }
