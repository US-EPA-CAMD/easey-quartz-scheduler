namespace Epa.Camd.Quartz.Scheduler
{
  public static class Constants
  {
    ...
    //   public static readonly string CHECK_ENGINE_EVALUATION_KEY = "{0} Evaluation";
    //   public static readonly string CHECK_ENGINE_EVALUATION_GROUP = QuartzGroups.EVALUATIONS;
    //   public static readonly string CHECK_ENGINE_EVALUATION_DESCRIPTION = "Evaluates a {0} data set for accuracy as specified by the EPA Part 75 reporting instructions.";
    ...
    //   public static readonly string CHECK_ENGINE_EVALUATION_KEY = "{0} Evaluation ({1} {2})";
    //   public static readonly string CHECK_ENGINE_EVALUATION_GROUP = QuartzGroups.EVALUATIONS;
    //   public static readonly string CHECK_ENGINE_EVALUATION_DESCRIPTION = "Evaluates a {0} data set for accuracy as specified by the EPA Part 75 reporting instructions.";
